...
field1 = {'rect':pygame.Rect( W*3/32,   H*5/32,  W/4, H/4), 'grow':False, 'time1':0, 'growth':0, 'crop':0, 'color':Blue, 'seeds':0,'speed':1}
field2 = {'rect':pygame.Rect( W*3/8,    H*5/32,  W/4, H/4), 'grow':False, 'time1':0, 'growth':0, 'crop':0, 'color':Blue, 'seeds':0,'speed':1}
field3 = {'rect':pygame.Rect( W*21/32,  H*5/32,  W/4, H/4), 'grow':False, 'time1':0, 'growth':0, 'crop':0, 'color':Blue, 'seeds':0,'speed':1}
field4 = {'rect':pygame.Rect( W*3/32,   H*7/16,  W/4, H/4), 'grow':False, 'time1':0, 'growth':0, 'crop':0, 'color':Blue, 'seeds':0,'speed':1}
field5 = {'rect':pygame.Rect( W*3/8,    H*7/16,  W/4, H/4), 'grow':False, 'time1':0, 'growth':0, 'crop':0, 'color':Blue, 'seeds':0,'speed':1}
field6 = {'rect':pygame.Rect( W*21/32,  H*7/16,  W/4, H/4), 'grow':False, 'time1':0, 'growth':0, 'crop':0, 'color':Blue, 'seeds':0,'speed':1}
field7 = {'rect':pygame.Rect( W*3/32,   H*23/32, W/4, H/4), 'grow':False, 'time1':0, 'growth':0, 'crop':0, 'color':Blue, 'seeds':0,'speed':1}
field8 = {'rect':pygame.Rect( W*3/8,    H*23/32, W/4, H/4), 'grow':False, 'time1':0, 'growth':0, 'crop':0, 'color':Blue, 'seeds':0,'speed':1}
field9 = {'rect':pygame.Rect( W*21/32,  H*23/32, W/4, H/4), 'grow':False, 'time1':0, 'growth':0, 'crop':0, 'color':Blue, 'seeds':0,'speed':1}
...
image_crop_1 = pygame.transform.scale(image_crop_1, (W/4,H/4))
image_crop_2 = pygame.transform.scale(image_crop_2, (W/4,H/4))
image_crop_3 = pygame.transform.scale(image_crop_3, (W/4,H/4))
image_crop_4 = pygame.transform.scale(image_crop_4, (W/4,H/4))
image_crop_5 = pygame.transform.scale(image_crop_5, (W/4,H/4))
...
plant_1 = {'rect':pygame.Rect(W/16,       H/2-H/8, W/4, H/4),   'crop':type_1}
plant_2 = {'rect':pygame.Rect(W/8+W/4,    H/2-H/8, W/4, H/4),   'crop':type_2}
plant_3 = {'rect':pygame.Rect(W*3/16+W/2, H/2-H/8, W/4, H/4),   'crop':type_3}
